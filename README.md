...
Trained model weights are regenerated by `run_main_experiment.py` (they are large
and not committed). The Solomon instances in `data/solomon/` are the standard
public benchmark.
